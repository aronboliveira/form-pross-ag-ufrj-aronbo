...
exports.addDblQuotes = exports.formatCEP = exports.addEmailExtension = exports.formatTel = exports.showGenFisAlin = exports.switchAutocorrect = exports.removeFirstClick = exports.autoCapitalizeCite = exports.autoCapitalizeInputs = exports.numberLimit = void 0;
        ...
        function undoMultipleUppercases() {
            ...
            unproperDUppercases.forEach((multipleUppercasesMatch) => {
                if (citeText && multipleUppercasesMatch) {
                    ...
                    let textArray = Array.from(citeText);
                    textArray.splice(upperCasesRepetitionsIndex + 1, loweredRepetitions.length, loweredRepetitions);
                    const multipleConjFix = /D[aeiouáàâäãéèêëíìîïóòôöõúùûü][s]\s[A-ZÁÀÂÄÃÉÈÊËÍÌÎÏÓÒÔÖÕÚÙÛÜ]{3,}/; //Dos SA + N=> dos AN
...
exports.showGenFisAlin = showGenFisAlin;
