/******/ (() => {
  ...
  \****************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ addAntMedHandler: () =>
            /* binding */ addAntMedHandler,
          /* harmony export */ enableCEPBtn: () => /* binding */ enableCEPBtn,
          /* harmony export */ searchCEP: () => /* binding */ searchCEP,
          /* harmony export */
        });
        /* harmony import */ var _global_scripts_src_gModel__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../../global-scripts/src/gModel */ "../../global-scripts/src/gModel.tsx"
          );
        /* harmony import */ var _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../../global-scripts/src/gHandlers */ "../../global-scripts/src/gHandlers.tsx"
          );
        /* harmony import */ var _global_scripts_src_errorHandler__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../../global-scripts/src/errorHandler */ "../../global-scripts/src/errorHandler.tsx"
          );
          ...
          if (cepElement && cepElement instanceof HTMLInputElement) {
            ...
            if (urlBAPI1) {
              ...
              xmlReq1.onload = () => {
                ...
                if (xmlReturn1 === 200) {
                  console.log(
                    `Primeira solicitação XML/HTTP feita com sucesso.`
                  );
                  if (progBar && progMax) {
                    uploadCEPLoadBar(
                      cepElement,
                  ...
                  if (urlBAPI2) {
                    ...
                    xmlReq2.onload = () => {
                      ...
                      if (xmlReturn2 === 200) {
                        console.log(
                          `Segunda solicitação XML/HTTP feita com sucesso.`
                        );
                        if (progBar && progMax) {
                          uploadCEPLoadBar(
                            cepElement,
        ...
        function loadCEP(xmlReq, reqAcc) {
          ...
          try {
            ...
            console.warn(
              `Status de Erro para CEPV${reqAcc}: `,
              loadError.message
            );
            status = 404;
          }
        ...
        function displayCEPLoadBar(cepElement) {
          ...
          if (
            progressBar &&
            cepElement.nextElementSibling?.nextElementSibling
          ) {
  ...
  `;
            ...
            for (let iT = 0; iT < textElements.length; iT++) {
              textElements[iT].addEventListener("input", () =>
                _global_scripts_src_gModel__WEBPACK_IMPORTED_MODULE_0__.autoCapitalizeInputs(
                  textElements[iT]
                )
              );
            }
            for (let iB = 0; iB < dateBtns.length; iB++) {
              dateBtns[iB].addEventListener("click", (activation) =>
                _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_1__.useCurrentDate(
                  activation,
                  dateBtns[iB]
                )
              );
            ...
            _global_scripts_src_errorHandler__WEBPACK_IMPORTED_MODULE_2__.elementNotFound(
              click.target ?? null,
  ...
  \*************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ addEmailExtension: () =>
            /* binding */ addEmailExtension,
          /* harmony export */ formatCEP: () => /* binding */ formatCEP,
          /* harmony export */ formatTel: () => /* binding */ formatTel,
          /* harmony export */
        });
        /* harmony import */ var _global_scripts_src_errorHandler__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../../global-scripts/src/errorHandler */ "../../global-scripts/src/errorHandler.tsx"
          );
        ...
        function addEmailExtension(container) {
          if (container instanceof HTMLInputElement || HTMLTextAreaElement) {
            ...
            const slicedError =
              new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
            _global_scripts_src_errorHandler__WEBPACK_IMPORTED_MODULE_0__.inputNotFound(
              container ?? null,
  ...
  \*****************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ JSONTitleStorager: () =>
            /* binding */ JSONTitleStorager,
          ...
          checkAtvLvl(person) {
            if (person && "atvLvl" in person && this.atvLvl !== "") {
              ...
              console.error(
                ...
                }; Valor de Nível de Atividade Física obtido: ${
                  this.atvLvl ?? "null"
                }`
              );
              return 0;
          ...
          calcIMC(person) {
            try {
              if (
                ...
                throw new Error(`Erro validando dados fornecidos. Elemento pessoa: ${
                  Object.prototype.toString.call(person).slice(8, -1) ?? "null"
  ...
  \**********************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ elementNotFound: () =>
            /* binding */ elementNotFound,
          /* harmony export */ elementNotPopulated: () =>
            /* binding */ elementNotPopulated,
          /* harmony export */ elementWithArrayError: () =>
            /* binding */ elementWithArrayError,
          /* harmony export */ elementWithObjectError: () =>
            /* binding */ elementWithObjectError,
          /* harmony export */ elementsNotFoundFunction: () =>
            /* binding */ elementsNotFoundFunction,
          /* harmony export */ inputNotFound: () => /* binding */ inputNotFound,
          /* harmony export */ matchError: () => /* binding */ matchError,
          /* harmony export */ maxNumberError: () =>
            /* binding */ maxNumberError,
          /* harmony export */ multipleElementsNotFound: () =>
            /* binding */ multipleElementsNotFound,
  ...
  .checked obitod: ${element?.checked || "NULL"}.`);
        ...
        function elementWithArrayError(
          context,
          array,
          arrayName,
          element,
  ...
  Instância de ${arrayName ?? "UNNAMED ARRAY"} obtido: ${
        ...
        function elementWithObjectError(
          context,
          object,
          element,
          elementName,
  ...
  Stringificação: ${JSON.stringify(array) ?? "NULL"}`);
        ...
        function multipleElementsNotFound(line, context, ...elements) {
          ...
          let errorMessage = `MULTIPLE ELEMENTS NOT FOUND, LINE ${
            line ?? "UNDEFINED"
          }:
  ...
  \*******************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ changeToAstDigit: () =>
            /* binding */ changeToAstDigit,
          /* harmony export */ cpbInpHandler: () => /* binding */ cpbInpHandler,
          /* harmony export */ createJSONAnchor: () =>
            /* binding */ createJSONAnchor,
          /* harmony export */ cursorCheckTimer: () =>
            /* binding */ cursorCheckTimer,
          /* harmony export */ deactTextInput: () =>
            /* binding */ deactTextInput,
          /* harmony export */ doubleClickHandler: () =>
            /* binding */ doubleClickHandler,
          /* harmony export */ getJSONDesc: () => /* binding */ getJSONDesc,
          /* harmony export */ opRadioHandler: () =>
            /* binding */ opRadioHandler,
          /* harmony export */ regenerateJSONBtn: () =>
            /* binding */ regenerateJSONBtn,
          /* harmony export */ resetarFormulario: () =>
            /* binding */ resetarFormulario,
          /* harmony export */ searchNextSiblings: () =>
            /* binding */ searchNextSiblings,
          /* harmony export */ searchParents: () => /* binding */ searchParents,
          /* harmony export */ searchPreviousSiblings: () =>
            /* binding */ searchPreviousSiblings,
          /* harmony export */ searchPreviousSiblingsById: () =>
            /* binding */ searchPreviousSiblingsById,
          /* harmony export */ subForm: () => /* binding */ subForm,
          /* harmony export */ updateSimpleProperty: () =>
            /* binding */ updateSimpleProperty,
          /* harmony export */ useCurrentDate: () =>
            /* binding */ useCurrentDate,
          /* harmony export */
        });
        /* harmony import */ var _gModel__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./gModel */ "../../global-scripts/src/gModel.tsx"
          );
        /* harmony import */ var _classes__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./classes */ "../../global-scripts/src/classes.tsx"
          );
        /* harmony import */ var _errorHandler__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./errorHandler */ "../../global-scripts/src/errorHandler.tsx"
          );
        //nesse file estão presentes principalmente as funções de manipulação dinâmica de texto e layout
        ...
        const mapIdsTitles = {
          ...
          genid: "Gênero",
          genBirthRelId:
            "Identidade_em_relação_ao_gênero_designado_na_nascença",
        ...
        function updateSimpleProperty(element) {
          if (element instanceof HTMLInputElement) {
            if (element.type === "radio" || element.type === "checkbox") {
              ...
              if (
                Number.isNaN(
                  parseFloat(element.value.replaceAll(/[^0-9.,+-]/g, ""))
                )
              ) {
                console.warn(
                  `element.value retornado como NaN, revertido para 0.`
                );
                return 0;
              } else {
      ...
      Object.prototype.toString.call(element).slice(8, -1) ?? "null"
        ...
        function getJSONDesc(inputs) {
          ...
          for (let j = 0; j < inputs.length; j++) {
            ...
            //criação do storager
            const nJSONInpStorager =
              new _classes__WEBPACK_IMPORTED_MODULE_1__.JSONStorager(
                inpIds[j],
                inpValues[j]
              );
            //criação da store
          ...
          for (let i = 0; i < titleElements.length; i++) {
            ...
            let closestParent =
              titleElements[i]?.closest("span") ||
              titleElements[i]?.closest("label");
            if (closestParent) {
              let loopAcc = 0;
              while (loopAcc < 10 && closestParent.textContent === "") {
                ...
                loopAcc++;
                closestParent =
                  closestParent?.closest("span") ||
                  closestParent?.closest("label");
              ...
              if (closestParent?.textContent !== "") {
                if (
                  ...
                  closestBooleanElementsIds.push(
                    booleanParentCopy.id ?? "null"
                  );
                  while (
                    loopAcc < 10 &&
                    closestParent &&
                  ...
                  if (
                    ...
                    if (
                      ...
                      titleElements[i]?.nextElementSibling instanceof
                        HTMLLabelElement &&
                      titleElements[i]?.nextElementSibling?.classList.contains(
                        "boolOp"
                      )
                    ) {
                  ...
                  if (closestParent?.id !== "") {
                    ...
                    if (
                      ...
                      const previousESibling =
                        titleElements[i]?.previousElementSibling;
                      if (
                        previousESibling &&
                  ...
                  if (titleElements[i]?.classList.contains("famOp")) {
                    ...
                    if (upperCaseMatch && titleElements[i]?.id) {
                      const upperCaseIndex =
                        titleElements[i]?.id.indexOf("Fam");
                      const slicedId = titleElements[i]?.id.slice(
                        0,
                        upperCaseIndex
                      );
                      closestValidElements.push(
                        slicedId +
                          ...
                          titleElements[
                            i
                          ]?.nextSibling?.textContent?.replaceAll(
                            /^[\s]+/g,
                            ""
                          ) ??
                          `NULL ${
          ...
          for (let l = 0; l < titleElements.length; l++) {
            ...
            const multipleSpaceMatches =
              closestValidElements[l]?.match(/\s\s/) ?? null;
            if (
            ...
            //criação do storager
            const nJSONTitleStorager =
              new _classes__WEBPACK_IMPORTED_MODULE_1__.JSONTitleStorager(
                closestValidElements[l]
              );
            //criação da store
          ...
          if (
            ...
            if (
              ...
              const filter2JSONInpsStore = JSONInpsStore.filter(
                (JSONEl) =>
                  JSONEl instanceof
                  _classes__WEBPACK_IMPORTED_MODULE_1__.JSONStorager
              );
              const filter2JSONTitlesStore = JSONTitlesStore.filter(
                (JSONEl) =>
                  JSONEl instanceof
                  _classes__WEBPACK_IMPORTED_MODULE_1__.JSONTitleStorager
              );
              if (
      ...
      Length obtida para titles: ${
        ...
        function opRadioHandler(keydown) {
          ...
          for (
            ...
            if (
              ...
              const slicedError =
                new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
              _errorHandler__WEBPACK_IMPORTED_MODULE_2__.multipleElementsNotFound(
                slicedError ?? "NULL",
        ...
        function cpbInpHandler(radio) {
          if (radio.parentElement && radio.parentElement.parentElement) {
            const opRadiosCheck =
              radio.parentElement?.parentElement?.querySelectorAll(
                "input[id^='Cpb'][id$='Yes']"
              );
            const opRadiosText =
              radio.parentElement?.parentElement?.querySelectorAll(
            ...
            if (opRadiosCheck.length > 0) {
              opRadiosCheck?.forEach(function (opRadioCheck, i) {
                if (
                  ...
                  (opRadioCheck.type === "checkbox" ||
                    opRadioCheck.type === "radio")
                ) {
            ...
            if (opRadiosText.length > 0) {
              opRadiosText?.forEach(function (opRadioText, i) {
                if (
                  ...
                  (opRadioText.type === "checkbox" ||
                    opRadioText.type === "radio")
                ) {
              ...
              antFamChecks?.forEach((antFamCheck, i) => {
                ...
                if (closestAddElement instanceof HTMLDivElement) {
                  if (
                    ...
                    (antFamCheck.type === "checkbox" ||
                      antFamCheck.type === "radio") &&
                    !antFamCheck.checked
                  ) {
        ...
        function useCurrentDate(activation, dateBtn) {
          ...
          if (
            ...
            const slicedError =
              new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
            _errorHandler__WEBPACK_IMPORTED_MODULE_2__.inputNotFound(
              targInputDate ?? null,
              "targInputDate",
              slicedError ?? "NULL"
            );
            ...
            if (
              ...
              if (inpAst instanceof HTMLInputElement) {
                ...
                if (inpAst.parentElement) {
                  ...
                  const idLabMatch =
                    labCont[0].id.match(/Ast/)?.toString() ?? "";
                  ...
                  if (idLabMatchIndex && idInpMatchIndex) {
                    ...
                    if (
                      toFileInpBtn.previousElementSibling instanceof
                      HTMLButtonElement
                    ) {
                      toFileInpBtn.previousElementSibling?.setAttribute(
                        "hidden",
                        ""
                      );
                    }
                          ...
                          if (imgFile && imgFile.type.startsWith("image")) {
                            ...
                            fileReader.onload = (load) => {
                              ...
                              if (
                                ...
                                fileInp.parentElement.replaceChild(
                                  imgAstDigt,
                                  fileInp
                                );
              ...
              if (
                ...
                if (inpAst.parentElement) {
                  ...
                  if (idLabMatch && idInpMatch) {
                    ...
                    toFileInpBtn.previousElementSibling?.removeAttribute(
                      "hidden"
                    );
                    fileInp.addEventListener("input", () =>
                      _gModel__WEBPACK_IMPORTED_MODULE_0__.autoCapitalizeInputs(
                        fileInp
                      )
                    );
                  } else {
                ...
                const slicedError =
                  new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) ||
                  "";
                _errorHandler__WEBPACK_IMPORTED_MODULE_2__.elementNotFound(
                  inpAst ?? null,
                  "inpAst",
                  slicedError ?? "NULL"
                );
        ...
        function resetarFormulario(click, toFileInpBtns) {
          if (
            ...
            const editableCite = document.querySelector(
            ...
            if (editableCite) {
              ...
              _gModel__WEBPACK_IMPORTED_MODULE_0__.removeFirstClick(
                editableCite
              );
            } else {
            ...
            toFileInpBtns.forEach((toFileInpBtn) => {
              if (
                ...
                if (
                  ...
                  if (inpAst.parentElement) {
                    let labCont =
                      toFileInpBtn.parentElement?.getElementsByClassName(
                        "labAst"
                      ) ?? "null";
                    if (
                      (labCont[0] === "null" || labCont[0].id === "") &&
                      (toFileInpBtn.parentElement?.tagName === "LABEL" ||
                        toFileInpBtn.parentElement?.tagName === "SPAN")
                    ) {
                      labCont = Array.of(toFileInpBtn.parentElement);
  ...
  \****************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ autoCapitalizeCite: () =>
            /* binding */ autoCapitalizeCite,
          /* harmony export */ autoCapitalizeInputs: () =>
            /* binding */ autoCapitalizeInputs,
          /* harmony export */ checkAllGenConts: () =>
            /* binding */ checkAllGenConts,
          /* harmony export */ filterIdsByGender: () =>
            /* binding */ filterIdsByGender,
          /* harmony export */ fluxGen: () => /* binding */ fluxGen,
          /* harmony export */ generatePersonInstance: () =>
            /* binding */ generatePersonInstance,
          /* harmony export */ hideGenFisAlin: () =>
            /* binding */ hideGenFisAlin,
          /* harmony export */ hideStgTransHorm: () =>
            /* binding */ hideStgTransHorm,
          /* harmony export */ normalizeNegatives: () =>
            /* binding */ normalizeNegatives,
          /* harmony export */ numberLimit: () => /* binding */ numberLimit,
          /* harmony export */ removeFirstClick: () =>
            /* binding */ removeFirstClick,
          /* harmony export */ showGenFisAlin: () =>
            /* binding */ showGenFisAlin,
          /* harmony export */ showStgTransHorm: () =>
            /* binding */ showStgTransHorm,
          /* harmony export */ switchAutocorrect: () =>
            /* binding */ switchAutocorrect,
          /* harmony export */
        });
        /* harmony import */ var _gHandlers__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./gHandlers */ "../../global-scripts/src/gHandlers.tsx"
          );
        /* harmony import */ var _classes__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./classes */ "../../global-scripts/src/classes.tsx"
        ...
        function numberLimit(inputElement) {
          ...
          if (
            (isAtivFis || isAlimRot || isLocNum || isDDD || isFreq) &&
            !isFloat
          ) {
        ...
        function autoCapitalizeInputs(textElement) {
          ...
          if (isAutocorrectOn && text) {
            ...
            let letterNotMatchesAfterD =
              text.match(notMatchesAfterDRegex) ?? [];
            ...
            const wrongStartMatch =
              text.match(wrongStartRegex)?.toString() ?? null;
              ...
              if (
                    ...
                    (() => {
                      if (letterMatchesIniNotD && !letterMatchesIniD) {
                        letterMatchesIniNotD.forEach((letterMatch) => {
                          remadeText = fixNextWordsIniNotD(
                            remadeText,
                            letterMatch
                          );
                        });
                        ...
                        (() => {
                          ...
                          (() => {
                            ...
                            for (
                              let iD = 0;
                              iD < arrayCheckLowerCasesD.length;
                              iD++
                            ) {
                              ...
                              if (filteredArrayD) {
                                ...
                                const regexTargLetter = new RegExp(
                                  targLetter,
                                  "g"
                                );
                                if (iD === 0) {
                ...
                if (letterMatchesIniD || letterMatchesIniNotD) {
                  ...
                  (() => {
                    ...
                    for (let iM = 0; iM < wordMatch.length; iM++) {
                      const uppercaseTest = uppercasesRegexObj.test(
                        wordMatch[iM]
                      );
                ...
                (() => {
                  if (wrongCharsMatchesOp1) {
                    textElement.value =
                      textElement.value?.replaceAll(wrongCharsRegexOp1, "") ??
                      null;
                  }
                  if (wrongCharsMatchesOp2) {
                    textElement.value =
                      textElement.value?.replaceAll(wrongCharsRegexOp2, "") ??
                      null;
                  }
                  if (wrongCharsMatchesOp3) {
                    textElement.value =
                      textElement.value?.replaceAll(wrongCharsRegexOp3, "") ??
                      null;
                  }
                  if (text.match(/\s[\s]+/g)) {
                    textElement.value =
        ...
        function autoCapitalizeCite(editableCite) {
          ...
          if (isAutocorrectOn && citeText) {
            ...
            const notMatchesAfterDRegex =
              /\sd[aeioáàâäãéèêëíìîïóòôöõúùûüAEIOÁÀÂÄÃÉÈÊËÍÌÎÏÓÒÔÖÕÚÙÛÜ][sS]?\s/g;
            let letterNotMatchesAfterD =
              citeText.match(notMatchesAfterDRegex) ?? [];
            const afterDRegexOp1 =
              /\sd[^aeioáàâäãéèêëíìîïóòôöõúùûüAEIOÁÀÂÄÃÉÈÊËÍÌÎÏÓÒÔÖÕÚÙÛÜ]/g;
            const afterDRegexOp2 =
              /\sd[aeioáàâäãéèêëíìîïóòôöõúùûüAEIOÁÀÂÄÃÉÈÊËÍÌÎÏÓÒÔÖÕÚÙÛÜ][^sS\s]/g;
            ...
            const wrongUppercasesRegexOp9 =
              /D[aeioáàâäãéèêëíìîïóòôöõúùûü][s]\s/g;
            ...
            const wrongStartRegex =
              /^[a-záàâäãéèêëíìîïóòôöõúùûü]+[A-ZÁÀÂÄÃÉÈÊËÍÌÎÏÓÒÔÖÕÚÙÛÜ]/;
            const wrongStartMatch =
              citeText.match(wrongStartRegex)?.toString() ?? null;
            const wrongCharsRegexOp1 =
              /[\s]*[\d\n,;.+\-=~\\/|"!@#$%&*¬°ªº§¹²³£¢(){}[\]]+[\s]*[\d\n,;.+\-=~\\/|"!@#$%&*¬°ªº§¹²³£¢(){}[\]]*/g;
            ...
            (() => {
              if (wrongCharsMatchesOp1) {
                editableCite.textContent =
                  editableCite.textContent?.replaceAll(
                    wrongCharsRegexOp1,
                    ""
                  ) ?? null;
                isCursorAutoMoved = moveCursorToTheEnd(
          ...
          function createSpanAlert(isSpanActive, isAlertMade) {
            ...
            if (
              ...
              if (
                nextCiteElementSibling === "deactAutocorrectBtn" &&
                !isSpanActive
              ) {
        ...
        function removeFirstClick(editableCite) {
          ...
          setInterval(() => {
            cursorPosition =
              _gHandlers__WEBPACK_IMPORTED_MODULE_0__.cursorCheckTimer(
                cursorPosition
              ) ?? 0;
          }, 3000);
        }
        ...
        function fluxGen(gen, genIniValue, genBirthRel, genTrans, genFisAlin) {
          ...
          if (gen.value === "masculino" || gen.value === "feminino") {
                ...
                if (
                  ...
                  if (genTrans.value === "intermediario") {
                    ...
                    if (gen.value === "feminino") {
                      const isMascSelected =
                        contMasculinizado?.selected ?? false;
                      if (isMascSelected) {
            ...
            const slicedError =
              new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
            _errorHandler__WEBPACK_IMPORTED_MODULE_2__.stringError(
              "obtendo gen.value",
        ...
        function filterIdsByGender(arrayIds, bodyType) {
          if (Array.isArray(arrayIds)) {
            if (
              ...
              const slicedError =
                new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
              _errorHandler__WEBPACK_IMPORTED_MODULE_2__.typeError(
        ...
        function generatePersonInstance(person) {
          if (typeof person.gen === "string" && person.gen !== "") {
            if (person.gen === "masculino") {
              person = new _classes__WEBPACK_IMPORTED_MODULE_1__.Man(
                person.gen,
                person.age,
                person.weight,
                person.height,
              ...
              person = new _classes__WEBPACK_IMPORTED_MODULE_1__.Woman(
                person.gen,
                person.age,
                person.weight,
                person.height,
              ...
              person = new _classes__WEBPACK_IMPORTED_MODULE_1__.Neutro(
                person.gen,
                person.age,
                person.weight,
                person.height,
  ...
  \******************************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _aGHandlers__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(/*! ./aGHandlers */ "./src/aGHandlers.tsx");
    /* harmony import */ var _aGModel__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./aGModel */ "./src/aGModel.tsx");
    /* harmony import */ var _global_scripts_src_gModel__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(
        /*! ../../global-scripts/src/gModel */ "../../global-scripts/src/gModel.tsx"
      );
    /* harmony import */ var _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(
        /*! ../../global-scripts/src/gHandlers */ "../../global-scripts/src/gHandlers.tsx"
      );
    /* harmony import */ var _global_scripts_src_errorHandler__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(
        /*! ../../global-scripts/src/errorHandler */ "../../global-scripts/src/errorHandler.tsx"
      );
    ...
    if (JSONBtn instanceof HTMLButtonElement && allInputs.length > 0) {
      ...
      JSONBtn.addEventListener("click", () => {
        formDescription =
          _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.getJSONDesc(
            allInputs
          );
        ...
        if (
          ...
          JSONLink =
            _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.createJSONAnchor(
              JSONBtn,
              JSONInpsStoreStringified
            );
          if (JSONLink) {
            JSONLink.addEventListener("click", () => {
              _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.regenerateJSONBtn(
                JSONLink,
                JSONInpsStoreStringified
              );
            });
            ...
            const slicedError =
              new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
            _global_scripts_src_errorHandler__WEBPACK_IMPORTED_MODULE_4__.elementNotFound(
              JSONLink ?? null,
              "JSONLink",
              slicedError ?? "NULL"
            );
      ...
      _global_scripts_src_errorHandler__WEBPACK_IMPORTED_MODULE_4__.elementNotPopulated(
        allInputs ?? null,
        "allInputs",
        slicedError ?? "NULL"
      );
        ...
        if (!isTelInput && !isEmailInput && !(textCont.id === "cepId")) {
          textCont.addEventListener("input", function (input) {
            if (
              ...
              _global_scripts_src_gModel__WEBPACK_IMPORTED_MODULE_2__.autoCapitalizeInputs(
                input.target
              );
            } else {
              const slicedError =
                new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
              _global_scripts_src_errorHandler__WEBPACK_IMPORTED_MODULE_4__.inputNotFound(
                input.target ?? null,
                "target textCont",
                slicedError ?? "NULL"
              );
      ...
      numInps.forEach(function (numInp) {
        numInp.addEventListener("input", function (input) {
          if (input.target && input.target instanceof HTMLInputElement) {
            _global_scripts_src_gModel__WEBPACK_IMPORTED_MODULE_2__.numberLimit(
              input.target
            );
          } else {
            const slicedError =
    ...
    if (areAllGenContChecked && typeof genValue === "string") {
      gen.addEventListener("change", () => {
        genValue =
          _global_scripts_src_gModel__WEBPACK_IMPORTED_MODULE_2__.fluxGen(
            gen,
            gen.value ?? null,
            genBirthRel,
            genTrans,
      ...
      emailInputs.forEach((emailInput) => {
        if (emailInput instanceof HTMLInputElement) {
          emailInput.addEventListener("click", () =>
            _aGModel__WEBPACK_IMPORTED_MODULE_1__.addEmailExtension(emailInput)
          );
      ...
      radioButtons.forEach((radio) => {
        if (radio instanceof HTMLInputElement && radio.type === "radio") {
          radio.addEventListener("keydown", (keydown) => {
            _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.opRadioHandler(
              keydown
            );
          });
          radio.addEventListener(
            "change",
            () =>
              _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.cpbInpHandler
          );
          radio.addEventListener(
            "keydown",
            () =>
          ...
          radio.addEventListener("dblclick", () =>
            _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.doubleClickHandler(
              radio
            )
          );
          ...
          radio.addEventListener(
            "change",
            _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.deactTextInput
          );
        } else {
          const slicedError =
            new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
    ...
    if (antMedContainer) {
      antMedContainer.addEventListener(
        "click",
        _aGHandlers__WEBPACK_IMPORTED_MODULE_0__.addAntMedHandler
      );
    } else {
      const slicedError =
        new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
      ...
      dateBtns.forEach(function (dateBtn) {
        if (dateBtn instanceof HTMLButtonElement) {
          dateBtn.addEventListener("click", (activation) => {
            _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.useCurrentDate(
              activation,
              dateBtn
            );
          });
    ...
    if (
      ...
      cepElement.addEventListener("input", () =>
        _aGModel__WEBPACK_IMPORTED_MODULE_1__.formatCEP(cepElement)
      );
      cepElement.addEventListener("input", () => {
        const isCepBtnOff =
          _aGHandlers__WEBPACK_IMPORTED_MODULE_0__.enableCEPBtn(
        ...
        if (
          ...
          cepElementBtn.addEventListener("click", () =>
            _aGHandlers__WEBPACK_IMPORTED_MODULE_0__.searchCEP(cepElement)
          );
      ...
      const slicedError =
        new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
      _global_scripts_src_errorHandler__WEBPACK_IMPORTED_MODULE_4__.multipleElementsNotFound(
        slicedError ?? "NULL",
        "Elements para CEP",
        cepElement ?? null,
        cepElementBtn ?? null
    ...
    if (qxPrinc && qxPrinc instanceof HTMLTextAreaElement) {
      qxPrinc.addEventListener("click", () =>
        _aGModel__WEBPACK_IMPORTED_MODULE_1__.addDblQuotes(qxPrinc)
      );
      qxPrinc.addEventListener("input", () =>
        _aGModel__WEBPACK_IMPORTED_MODULE_1__.addDblQuotes(qxPrinc)
      );
    } else {
      const slicedError =
    ...
    if (editableCite) {
      ...
      const citeClickHandler = function (click) {
        if (firstClick && click.target && click.target instanceof HTMLElement) {
          _global_scripts_src_gModel__WEBPACK_IMPORTED_MODULE_2__.removeFirstClick(
            click.target
          );
          firstClick = false;
      ...
      editableCite.addEventListener("keyup", function (keypress) {
        if (keypress.target && keypress.target instanceof HTMLElement) {
          _global_scripts_src_gModel__WEBPACK_IMPORTED_MODULE_2__.autoCapitalizeCite(
            keypress.target
          );
        } else {
          const slicedError =
      ...
      deactAutocorrectBtns.forEach(function (deactAutocorrectBtn) {
        if (deactAutocorrectBtn instanceof HTMLButtonElement) {
          deactAutocorrectBtn.addEventListener("click", function (click) {
            return _global_scripts_src_gModel__WEBPACK_IMPORTED_MODULE_2__.switchAutocorrect(
              click,
              deactAutocorrectBtn
            );
          });
      ...
      astDigtBtns.forEach(function (astDigtBtn) {
        if (astDigtBtn instanceof HTMLButtonElement) {
          astDigtBtn.addEventListener("click", function (click) {
            return _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.changeToAstDigit(
              click,
              astDigtBtn
            );
          });
    ...
    if (subButton instanceof HTMLButtonElement) {
      subButton.addEventListener(
        "click",
        _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.subForm
      );
    } else {
      const slicedError =
        new Error().stack?.split("\n")[1]?.trim()?.slice(-7, -1) || "";
    ...
    if (resetFormBtn instanceof HTMLButtonElement) {
      resetFormBtn.addEventListener("click", (click) =>
        _global_scripts_src_gHandlers__WEBPACK_IMPORTED_MODULE_3__.resetarFormulario(
          click,
          astDigtBtns
        )
      );
