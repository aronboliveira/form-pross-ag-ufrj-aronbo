    ...
    if (Array.isArray(arrayIds) &&
        ...
        switch (bodyType) {
            ...
            case "neutro":
                ...
                break;
            default:
                ErrorHandler.stringError(`obtendo bodyType válido`, bodyType, extLine(new Error()));
        }
    }
    else {
        ErrorHandler.typeError(`Erro validando array em filterIdsByGender().
      Validando elementos para definição de gênero como strings`, bodyType, "string", extLine(new Error()));
    }
